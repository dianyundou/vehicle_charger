...
#define DEBUG_TAG_HIGH            R_IOPORT_PinWrite(&g_ioport_ctrl, BSP_IO_PORT_00_PIN_10, BSP_IO_LEVEL_HIGH)
#define DEBUG_TAG_LOW             R_IOPORT_PinWrite(&g_ioport_ctrl, BSP_IO_PORT_00_PIN_10, BSP_IO_LEVEL_LOW)
