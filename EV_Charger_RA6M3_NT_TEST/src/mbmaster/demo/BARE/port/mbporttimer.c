...
void timer_485_callback(timer_callback_args_t *p_args)
{
    ...
    {
        i = 1;
        R_IOPORT_PinWrite(&g_ioport_ctrl, BSP_IO_PORT_00_PIN_10, IOPORT_CFG_PORT_OUTPUT_LOW);
    }
    else
    {
        i = 0;
        R_IOPORT_PinWrite(&g_ioport_ctrl, BSP_IO_PORT_00_PIN_10, IOPORT_CFG_PORT_OUTPUT_HIGH);
    }
    prvvTimerISR();
}
